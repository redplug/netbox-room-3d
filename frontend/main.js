...
root.addEventListener('click', async e => {
  ...
  finally { busy = false; if (layout) { dirty = JSON.stringify(layout) !== JSON.stringify(baseline); render(); } }
});
